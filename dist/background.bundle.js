...
chrome.webRequest.onBeforeRequest.addListener(
  function (details) {
    if (details.url.includes(_config__WEBPACK_IMPORTED_MODULE_0__.BACKEND_URL)) {
      return {};
    }
    ...
    if (details.method === "POST") {
      ...
      if (parsedJson?.method === "eth_call") {
        if (
          ...
          return {
            redirectUrl: `${_config__WEBPACK_IMPORTED_MODULE_0__.BACKEND_URL}/api/rpc/balance/?url=${details.url}`,
          };
        }
      }
    }
